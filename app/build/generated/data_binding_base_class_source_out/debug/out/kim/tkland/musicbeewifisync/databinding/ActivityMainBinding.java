...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Toolbar myToolbar,
      @NonNull RadioButton reverceFromGoneMAD, @NonNull RadioButton reverceFromNone,
      @NonNull RadioButton reverceFromPoweramp, @NonNull LinearLayout syncFrom,
      @NonNull CheckBox syncFromMusicBee, @NonNull TextView syncFromPrompt,
      @NonNull Guideline syncHalfWidthGuideline, @NonNull Button syncPreviewButton,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, myToolbar, reverceFromGoneMAD,
          reverceFromNone, reverceFromPoweramp, syncFrom, syncFromMusicBee, syncFromPrompt,
          syncHalfWidthGuideline, syncPreviewButton, syncServerStatus, syncStartButton,
          syncStartButtonImage, syncStartButtonText, syncTo, syncToPlayCounts, syncToPlaylistPath,
          syncToPlaylists, syncToPrompt, syncToRatings, syncToUsingPlayer, syncToUsingPrompt);
    }
